...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Number7 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"52.34.40.255", "52.34.40.255"},
    {"52.33.110.112", "52.33.110.112"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Number7 is probably already running."), addrBind.ToString().c_str());
        else
